...
class TestImageProcessingServiceLocale:
    ...
    def test_generate_prompt_with_locale(self, image_processor, mock_prompt_service):
        ...
        mock_prompt_service.get_prompt.assert_called_with(
            "home_maintenance_analysis", "he"
        )

        # Test with English locale (default)
        image_processor.generate_prompt(locale="en")
        mock_prompt_service.get_prompt.assert_called_with(
            "home_maintenance_analysis", "en"
        )
    ...
    @pytest.mark.unit
    def test_generate_prompt_with_context_and_locale(
        self, image_processor, mock_prompt_service
    ):
    ...
    @pytest.mark.unit
    def test_generate_prompt_called_with_locale_in_workflow(
        self, image_processor, mock_prompt_service
    ):
    ...
    @pytest.mark.unit
    def test_generate_prompt_handles_prompt_service_error(
        self, image_processor, mock_prompt_service
    ):
        ...
        mock_prompt_service.get_prompt.side_effect = PromptNotFoundError(
            "Prompt not found"
        )
    ...
    @pytest.mark.unit
    def test_generate_prompt_locale_parameter_types(
        self, image_processor, mock_prompt_service
    ):
