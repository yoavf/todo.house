...
class TestImageLibrary:
    ...
    def get_scenarios_by_difficulty(self, difficulty: str) -> List[TestScenario]:
        ...
        """
        return [
            scenario for scenario, metadata in self._metadata_cache.items()
    ...
    def _draw_bathroom_sink(self, draw: Any, width: int, height: int, 
        ...
        for spot in spots:
            draw.ellipse([spot[0]-5, spot[1]-5, spot[0]+5, spot[1]+5], fill='white')
    ...
    def _draw_kitchen_appliances(self, draw: Any, width: int, height: int,
        ...
        for spot in grease_spots:
            draw.ellipse([spot[0]-15, spot[1]-10, spot[0]+15, spot[1]+10], 
    ...
    def _draw_lawn_maintenance(self, draw: Any, width: int, height: int,
        ...
        # Uneven edges
        draw.polygon([(0, 300), (50, 290), (100, 305), (150, 295), (200, 300), 
    ...
    def _draw_dishwasher_interior(self, draw: Any, width: int, height: int,
        ...
        for spot in debris_spots:
            draw.ellipse([spot[0]-6, spot[1]-6, spot[0]+6, spot[1]+6], 
                        fill='brown', outline='#8B4513')
    ...
    def _draw_bathroom_shower(self, draw: Any, width: int, height: int,
        ...
        for x in range(100, 700, tile_size):
            for y in range(100, 500, tile_size):
                draw.rectangle([x, y, x+tile_size-2, y+tile_size-2], 
        ...
        for area in soap_areas:
            draw.ellipse([area[0]-20, area[1]-15, area[0]+20, area[1]+15], 
                        fill='lightyellow', outline='yellow')
    ...
    def create_custom_test_image(self, description: str, width: int = 800, 
