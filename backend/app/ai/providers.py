...
class AITask(BaseModel):
    ...
    priority: str = Field(..., pattern="^(high|medium|low)$", description="Task priority level")
    category: str = Field(..., description="Task category (cleaning, repair, maintenance, safety, etc.)")
    reasoning: str = Field(..., description="Explanation of why this task was identified")
    confidence: float = Field(..., ge=0.0, le=1.0, description="Confidence score for this task (0.0-1.0)")
    ...
    def _parse_response(self, response: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                logger.info(f"Gemini raw response: {json.dumps(parsed_data, indent=2)[:1000]}...")
            except json.JSONDecodeError as e:
                logger.error(f"Failed to parse JSON from Gemini structured response: {e}")
...
class MockProvider(AIProvider):
    ...
    def __init__(self, **kwargs):
        ...
        self.mock_responses = kwargs.get("mock_responses", self._get_default_responses())
    ...
    async def analyze_image(self, image_data: bytes, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.cycle_responses:
                response_data = self.mock_responses[self.response_index % len(self.mock_responses)]
