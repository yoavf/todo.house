...
class TestGeminiProvider:
    ...
    def test_gemini_provider_initialization_import_error(self):
        ...
        with patch('google.generativeai.configure', side_effect=ImportError("Module not found")):
    ...
    async def test_gemini_provider_analyze_image_rate_limit_error(self):
        ...
        with patch('google.generativeai.configure'), \
            ...
            with patch.object(provider, '_make_api_call', side_effect=Exception("Rate limit exceeded")):
    ...
    async def test_gemini_provider_analyze_image_api_error(self):
        ...
        with patch('google.generativeai.configure'), \
            ...
            with patch.object(provider, '_make_api_call', side_effect=Exception("API error occurred")):
    ...
    async def test_gemini_provider_analyze_image_generic_error(self):
        ...
        with patch('google.generativeai.configure'), \
            ...
            with patch.object(provider, '_make_api_call', side_effect=Exception("Unexpected error")):
...
class TestAIProviderFactory:
    ...
    def test_register_invalid_provider(self):
        ...
        with pytest.raises(ValueError, match="Provider class must implement AIProvider interface"):
